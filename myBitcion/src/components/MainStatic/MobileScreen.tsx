import { FaCoins, FaExchangeAlt, FaRegBell, FaWallet } from "react-icons/fa";
import {
  MdDashboard,
  MdForwardToInbox,
  MdLogout,
          ...
          <div className="w-full flex px-2 mt-6 ">
            <div className=" w-16 h-8 object-cover flex items-center justify-center">
              <div className="flex ml-64">
                <MdForwardToInbox className="mr-4" cursor="pointer" size={25} />
                <FaRegBell cursor="pointer" size={25} />
                {/* <MdOutlineNotifications /> */}
              </div>
            </div>
            <div className="ml-2">
