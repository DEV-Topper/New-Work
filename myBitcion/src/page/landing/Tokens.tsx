...
const Tokens = () => {
  return (
    <div className="w-full min-h-[80vh] pt-10 lg:pt-0 flex justify-center items-center bg-blue-600">
      <div className="w-[80%] text-white flex flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-3/5">
          ...
          <div className="w-full grid grid-cols-2 gap-4 grid-rows-3">
            {Array.from({ length: 6 }, () => (
            ...
            <div className="border w-full border-white p-2 py-10 flex justify-center items-center flex-col">
              <div className="grid grid-cols-4 gap-2">
                <div className="space-y-2 text-center">
                  <div className="p-5 border border-white flex items-center justify-center text-[40px] font-bold">
                    00
                  </div>
                  <h4 className="text-[17px] ">DAYS</h4>
                </div>
                <div className="space-y-2 text-center">
                  <div className="p-5 border border-white flex items-center justify-center text-[40px] font-bold">
                    00
                  </div>
                  <h4 className="text-[17px] ">HOURS</h4>
                </div>
                <div className="space-y-2 text-center">
                  <div className="p-5 border border-white flex items-center justify-center text-[40px] font-bold">
                    00
                  </div>
                  <h4 className="text-[17px] ">MINUTES</h4>
                </div>
                <div className="space-y-2 text-center">
                  <div className="p-5 border border-white flex items-center justify-center text-[40px] font-bold">
                    00
                  </div>
                  <h4 className="text-[17px] ">SECONDS</h4>
                </div>
              </div>
