    ...
    <div className="w-full flex justify-center items-center min-h-[50vh] pt-10 lg:pt-0 bg-blue-600">
      <div className="w-[80%] flex flex-col items-center text-center text-white">
        ...
        <p className="font-semibold my-5">
          Competitive advantages are conditions that allow a company or country
          to produce a good <br /> or service at equal value but at a lower
        ...
        <div className="w-full flex flex-wrap justify-center gap-5">
          ...
          <div className="p-3 flex flex-col items-center space-y-2 rounded-lg bg-blue-700 shadow-lg">
            <img src={tokens} alt="" />
            <p className="font-semibold text-[18px]">Excerpt Tokens</p>
          </div>
          <div className="p-3 flex flex-col items-center space-y-2 rounded-lg bg-blue-700 shadow-lg">
            <img src={ease} alt="" />
          ...
          <div className="p-3 flex flex-col items-center space-y-2 rounded-lg bg-blue-700 shadow-lg">
            <img src={cash} alt="" />
            <p className="font-semibold text-[18px]">Daily Cash Outs</p>
          </div>
          <div className="p-3 flex flex-col items-center space-y-2 rounded-lg bg-blue-700 shadow-lg">
            <img src={phone} alt="" />
            <p className="font-semibold text-[18px]">Smart Application</p>
          </div>
          <div className="p-3 flex flex-col items-center space-y-2 rounded-lg bg-blue-700 shadow-lg">
            <img src={secure} alt="" />
